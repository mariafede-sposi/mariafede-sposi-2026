...
export default function Regali({ show, handleShow, handleClose }) {
    ...
    return (
        <div>
            ...
            <div style={{ backgroundColor: '#F9F6F2', padding: 20 }}>
                ...
                <br />
                Federico Cremona
                <div style={{ fontSize: '1.5em' }}>IT07M0306973981100000008064</div>
                <div
                ...
                <div style={{ fontSize: '1.5em' }}> IT03P3608105138294612294618</div>
                <div
